...
if __name__ == "__main__":
    ...
    for year in tqdm(years):
        ...
        train_data = pd.read_parquet(f"/share/garg/arxiv_kaggle/train/arxiv_tokenized_{year}_ai_{category}_{subsample_size}_sentence.parquet")
        ...
        estimate_text_distribution(human_train, ai_train, f"/share/garg/arxiv_kaggle/train/arxiv_tokenized_{train_start_year}_logprob_{category}_{subsample_size}.parquet")