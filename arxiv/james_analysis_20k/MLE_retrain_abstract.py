...
if __name__ == "__main__":
    ...
    for train_year in train_years:
        ...
        val_data = pd.read_parquet(f"/share/garg/arxiv_kaggle/train/arxiv_tokenized_{train_year}_ai_{category}_{subsample_size}_abstract.parquet")
        ...
        # Make a line plot
        plt.plot(train_years[:len(sols)], sols, marker='o')
