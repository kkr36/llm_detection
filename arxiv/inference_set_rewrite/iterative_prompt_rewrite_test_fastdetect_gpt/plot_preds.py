...
DIR = "."
# per-mirror sigmoid(d) = pseudo-P(AI) over iterations (lower = more human).
# The headline attack metric is AUC (see compute_auc.py); this is a per-abstract view.
pattern = f"{DIR}/results_*_oss_val_15_fastdetect.csv"
