...
query_fns = [call_gemini_2_flash_lite, call_gemini_2_flash, skip_model, skip_model]
# query_fns = [openai_oss_query] * 4
llm_labels = ["Gemini 2.0 Flash-Lite", "Gemini 2.0 Flash", "Gemini 2.5 Flash", "Gemini 3 Preview"]
...
if __name__ == "__main__":
    ...
    for year in tqdm(train_years):
        ...
        # import pdb; pdb.set_trace()
        year_df.to_parquet(f"/share/garg/arxiv_kaggle/multillm/data_raw/arxiv_{year}_ai_{category}_{subsample_size//2}_fronthalf_gemini.parquet")
