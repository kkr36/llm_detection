...
def rewrite_strategy_v16(prompt_model, abstract, model_name):
    raise NotImplementedError

def rewrite_strategy_v17(prompt_model, abstract, model_name):
    raise NotImplementedError

def rewrite_strategy_v18(prompt_model, abstract, model_name):
    raise NotImplementedError

def rewrite_strategy_v19(prompt_model, abstract, model_name):
    raise NotImplementedError

def rewrite_strategy_v20(prompt_model, abstract, model_name):
    raise NotImplementedError
...
CURRENT_STRATEGY = rewrite_strategy_v16
CURRENT_TIMESTEP = 16
