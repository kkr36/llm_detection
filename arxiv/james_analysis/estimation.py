...
if __name__ == "__main__":
    ...
    # for year in tqdm(list(range(2010,2026))):
    for year in [2020]:
        ...
        estimate_text_distribution(train_path, train_path, f"/share/garg/arxiv_kaggle/train/arxiv_tokenized_{train_start_year}_{train_end_year}_logprob_{category}_{subsample_size}.parquet")