...
if __name__ == "__main__":
    ...
    for train_year in tqdm(train_years):
        ...
        val_path = f"/share/garg/arxiv_kaggle/alpha/val/arxiv_tokenized_{train_year}_{category}_{subsample_size_val}.parquet"
        ...
        for alpha in alphas:
            ...
            print(f"{train_year} {alpha}: {solution} += {half_width}")
    ...
    ax = plt.subplot()
    for alpha in alphas:
        ax.plot(train_years, sols[alpha], label=alpha)
