...
if __name__ == "__main__":
    splits = ['train', 'test_sample'][:1]
    data_sizes = [6000, 1000][:1]

    for split, data_size in zip(splits, data_sizes):
        train_data = pd.read_parquet(f"/share/garg/kkr36/Task_A/{split}_tokenized_{data_size}.parquet")
        ...
        estimate_text_distribution(human_data, ai_data, f"/share/garg/kkr36/Task_A/{split}_logprob_{data_size}.parquet")