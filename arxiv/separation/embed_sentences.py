...
Output: embeddings.npz with keys 'embeddings' (N x D) and 'labels' (N,)
"""
...
DATA_PATH = (
    ...
    "arxiv_2010_ai_cs._10000_fronthalf_120b_qwen.parquet"
)
OUT_PATH = "/home/kkr36/llm_detection/arxiv/separation/embeddings.npz"
