...
def plot_temporal_combined(data, show_title=False):
    ...
    legend_handles = [
        ...
        Line2D([0], [0], color='steelblue', linestyle='-', linewidth=2.5, label='PU with Test-Time Adaptation'),
    ]
...
def plot_temporal_alpha_grid(data, metrics, show_title=True):
    ...
    series = [("Supervised 2010", pn_2010), ("PU Retrain", tedn_retrain)]
    x_lab = "test_year"
...
if __name__ == "__main__":
    ...
    for title in titles:
        ...
        # plot_temporal_combined(data, show_title=title)
        plot_temporal_alpha_grid(data, plot_metrics, title)
