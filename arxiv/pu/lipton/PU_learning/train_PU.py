...
for valalpha in tqdm(val_alphas):
    ...
    p_validloader_alpha, u_validloader_alpha, p_validdata_alpha, u_validdata_alpha = \
        get_dataset_val2(data_dir, data_type,net_type, device, valalpha, beta, batch_size, year)
...
if train_method=='PvU': 
    ...
    if estimate_alpha:
        for valalpha in tqdm(val_alphas):
            ...
            scott_mpe_estimator = scott_estimator(pos_probs, unlabeled_probs)
            EN_estimate = estimator_CM_EN(pos_probs, unlabeled_probs[:,0])
            outfile.write("{}, {}, {}, {}\n".format(valalpha, our_mpe_estimate, scott_mpe_estimator, EN_estimate))
    ...
    if estimate_alpha:
        for valalpha in tqdm(val_alphas):
            ...
            scott_mpe_estimator = scott_estimator(pos_probs, unlabeled_probs)
            EN_estimate = estimator_CM_EN(pos_probs, unlabeled_probs[:,0])
            outfile.write("{}, {}, {}, {}, {}\n".format(valalpha, our_mpe_estimate, scott_mpe_estimator, EN_estimate, naive_mpe_estimate))
