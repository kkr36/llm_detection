...
# SWITCHES
entrance_path = "/share/garg/arxiv_kaggle/sensitivity_models/xy_mini"
sentence = True
clean = True
epochs = 3
...
output_csv = "logging_accuracy_xz_counts_mini_v2.csv"
...
for cfg in configs:
    ...
    for eval_llm_col in eval_cols:
        ...
        for seed, net in nets.items():
            ...
            save_preds(
                f"{PREDS_BASE}/xz_counts_mini_v2/{train_method}/{llm}/{eval_llm_col}/seed_{seed}.npz",
