...
if __name__ == "__main__":
    ...
    for year in tqdm(years):
        ...
        for train_method in train_methods:
            ...
            alphas = [alpha] if year != 2020 else [0, .15, .3, .45, .6][::-1]
            ...
            for alpha in alphas:
                ...
                cmd = f"python train_PU_one_year.py --lr=0.00001 --momentum=0 --data-type='ArXiv_BERT' --train-method={train_method} --net-type='DistilBert' --epochs={epochs} --optimizer=AdamW --alpha={alpha} --beta=.6 --year={year} --log-dir=logging_accuracy_temporal_alpha_full_sentence/sentence_drop_{year}/{alpha} --clean"
