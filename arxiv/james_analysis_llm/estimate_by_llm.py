...
if __name__ == "__main__":
    ...
    for year in tqdm(years):
        for llm_col in llm_cols:
            ...
            train_data = pd.read_parquet(f"/share/garg/arxiv_kaggle/multillm/train/arxiv_tokenized_{year}_ai_{category}_{subsample_size}_{llm_col}_sentence.parquet")
            ...
            estimate_text_distribution(human_train, ai_train, f"/share/garg/arxiv_kaggle/train/arxiv_tokenized_{year}_logprob_{category}_{subsample_size}_{llm_col}.parquet")